              ...
              <div style={{ width: "100%", height: 360, background: "#fff", borderRadius: 12, padding: 12 }}>
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={cumulative} margin={{ top: 8, right: 16, left: 0, bottom: 8 }}>
                    ...
                    <XAxis dataKey="label" tick={{ fontSize: 12, fontFamily: "sans-serif", fontWeight: 100, stroke: " #000000" }} />
                    <YAxis allowDecimals={false} tick={{ fontSize: 12, fontFamily: "sans-serif", fontWeight: 100, stroke: " #000000" }} />
                    <Tooltip />
                    <Line
                      type="monotone"
                      dataKey="count"
